...
public final class ChainApplicationManager_Factory implements Factory<ChainApplicationManager> {
  ...
  public ChainApplicationManager_Factory(
  ...
  public static ChainApplicationManager_Factory create(
      ...
      Provider<PerformanceMonitor> performanceMonitorProvider,
      Provider<NetworkMonitor> networkMonitorProvider) {
    return new ChainApplicationManager_Factory(authenticationServiceProvider, blockchainManagerProvider, encryptionServiceProvider, messagingServiceProvider, p2pManagerProvider, webrtcManagerProvider, cloudStorageManagerProvider, notificationServiceProvider, offlineMessageQueueProvider, crossDeviceSyncServiceProvider, disappearingMessageManagerProvider, securityMonitoringManagerProvider, performanceMonitorProvider, networkMonitorProvider);
  }

  public static ChainApplicationManager newInstance(AuthenticationService authenticationService,
      BlockchainManager blockchainManager, SignalEncryptionService encryptionService,
      MessagingService messagingService, P2PManager p2pManager, WebRTCManager webrtcManager,
      CloudStorageManager cloudStorageManager, NotificationService notificationService,
      OfflineMessageQueue offlineMessageQueue, CrossDeviceSyncService crossDeviceSyncService,
